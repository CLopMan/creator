...
El trabajo se divide en varias fases, comenzando por un análisis detallado del estado del arte, donde se examinan otras arquitecturas vectoriales como AVX (x86), NEON (ARM) y la propia extensión V de RISC-V. También se comparan diferentes simuladores disponibles, como SPIKE y SAIL, destacando la ventaja de CREATOR por su accesibilidad web y enfoque educativo.
