 ...
 */
  ...
  template:   ' <div>' +
              ...
              '         <b-container fluid align-h="center" class="px-0 mx-0 mb-2" v-if="(data_mode == architecture.components[item.index].type) || (data_mode == \'int_registers\' && architecture.components[item.index].type == \'ctrl_registers\' && architecture.components[item.index].name != \'Vec Control Registers\') || (data_mode == \'vec_registers\' && architecture.components[item.index].type == \'ctrl_registers\' && architecture.components[item.index].name == \'Vec Control Registers\')">' +
